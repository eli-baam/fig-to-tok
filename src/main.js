...
async function run() {
    try {
        ...
        showUI({ width: ((saved === null || saved === void 0 ? void 0 : saved.w) || 380), height: ((saved === null || saved === void 0 ? void 0 : saved.h) || 190) });
        // 메시지 수신(RESIZE/CLOSE)
        onMessage(async (msg) => {
            if ((msg === null || msg === void 0 ? void 0 : msg.type) === "RESIZE") {
        ...
        // 3) W3C 포맷
        const w3cVars = buildW3CFromVariables(collections, variables, tokensByMode);
        const w3cType = await buildTypeStyles(text);
        const w3cShadow = buildShadows(effect);
        const payload = Object.assign(Object.assign(Object.assign({}, w3cVars), w3cType), w3cShadow);
